...
> = ({ member }) => {
  return (
    <div className="flex text-center md:text-start flex-col justify-center">
      <h3 className="card__title mb-0 text-base dark:text-[var(--azul-niebla)]">{member.name}</h3>
      <div className="card__subtitle text-xs dark:text-[var(--azul-niebla)]">{member.title}</div>
