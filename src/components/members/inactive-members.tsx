                                    ...
                                    <div className="relative flex items-center gap-8 mb-8">
                                        ...
                                        <div className="flex-1">
                                            ...
                                            <p className="text-gray-600 mt-1">
                                                {grouped[period].length} miembro
                                                {grouped[period].length !== 1 ? "s" : ""}
                                                {period !== "Sin periodo"
                                                    ? ` ${grouped[period].length !== 1 ? "ingresaron" : "ingresó"} en este periodo`
                                                    : ""}
                                            </p>
                                        </div>
                                    </div>
                                                    ...
                                                    <div className="card flex-row p-md transition-all duration-300 hover:scale-[1.025] overflow-hidden">
                                                        ...
                                                        <div className="flex flex-row items-left gap-6 w-full">
                                                            ...
                                                            <div className="flex flex-col justify-center">
                                                                <h3 className="card__title mb-0 text-base">
                                                                    {member.name}
                                                                </h3>
                                                                <div className="card__subtitle text-xs">
                                                                    {member.title}
                                                                </div>
